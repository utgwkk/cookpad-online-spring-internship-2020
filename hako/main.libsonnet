...

{
  container(appCpu, appMemory):: {
    ...
    env: {
      ...
      DATABASE_URL: std.format('mysql2://%(user)s@%(github_id)s-aurora-cluster.cluster-%(aurora_id)s.ap-northeast-1.rds.amazonaws.com:3306/
main?encoding=utf8mb4&collation=utf8mb4_bin', { user: provide('mysql_user'), github_id: github_id, aurora_id: provide('aurora_id') }),      DATABASE_PASSWORD: provide('mysql_password'),
